 ...
 */
class Tx_Fed_ViewHelpers_ExistsViewHelper extends Tx_Fed_Core_ViewHelper_AbstractConditionViewHelper {
	...
	public function render() {
		...
		if (isset($this->arguments['file'])) {
			$this->evaluation = (file_exists($file) || file_exists(PATH_site . $file)) && is_file($file);
		} else if (isset($this->arguments['directory'])) {
			$this->evaluation = (is_dir($directory) || is_dir(PATH_site . $directory));
		}
