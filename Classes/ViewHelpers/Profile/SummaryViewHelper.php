 ...
 */
class Tx_Fed_ViewHelpers_Profile_SummaryViewHelper extends Tx_Fed_Core_ViewHelper_AbstractViewHelper {
	...
	public function render() {
		...
		$templateFile = t3lib_extMgm::extPath('fed', 'Resources/Private/Templates/Profile/Summary.html');
