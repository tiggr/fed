 ...
 */
class Tx_Fed_ViewHelpers_Widget_Solr_Facet_TemplateViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	public function render() {
		$this->tag->addAttribute('class', 'fed-solr-facet-template');
