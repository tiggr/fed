 ...
 * @package Fed
 * @subpackage ViewHelpers/Widget/Solr/Facet/Group
 */
class Tx_Fed_ViewHelpers_Widget_Solr_Facet_Group_TitleViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractTagBasedViewHelper {
	...
	public function render() {
		...
		$this->tag->addAttribute('class', 'fed-solr-facet-group-title-template');
